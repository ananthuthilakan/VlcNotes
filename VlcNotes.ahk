...
Global Credits := "Credits : `n Vlc media player `n evilC - AppFactory  `n just me - Imagebutton  `n iseahound - ImagePut `niseahound - OCR`n Geek - cJSON`nnickstokes `nShinesOverlay`n unknown"
